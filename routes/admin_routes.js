...
router.get("/allTrainer", trainerController.allTrainer)
...
router.put("/updateTrainerByAdmin/:id", Validators.forParams(Schema.params), Validators.forReqBody(Schema.trainerSchema), trainerController.updateTrainerByAdmin)
