...
router.post("/particularBodyPartt/:bodyPartId", Validators.forReqBody(Schema.bodyPartByDate), Validators.forParams(Schema.bodyPartId), measurmentController.particularBodyPartByDate);
